...
@Component({
  selector: 'app-total-exclusion-of-fixed-assets',
  templateUrl: './total-exclusion-of-fixed-assets.component.html',
  styleUrls: ['./total-exclusion-of-fixed-assets.component.css']
})
export class TotalExclusionOfFixedAssetsComponent implements OnInit {
  ...
  ViewReport() {
    ...
    this.ReportSer.TotalExclusionOfFixedAssets(this.sDate, this.eDate, this.ComIDS, this.dbIds, this.currentLocation).subscribe(
      (data: Response) => {
        debugger;
        this.result = data;
