...
@Component({
  selector: 'app-institution-trial-balance',
  templateUrl: './institution-trial-balance.component.html',
  styleUrls: ['./institution-trial-balance.component.css']
})
export class InstitutionTrialBalanceComponent implements OnInit {
  ...
  private router: Router, private datehelp: DateHelperService, private translate: TranslateService) { }
    ...
    ViewReport() {
      ...
      this.ReportSer.InstitutionTrialBalance(this.sDate, this.dbIds).subscribe(
        (data: Response) => {
          debugger;
          this.result = data;
    ...
    ViewReportDesign() {
     ...
     StiOptions.WebServer.url = "http://localhost:63103/api/ReportData/GetDataSource"
      ...
      this.report.loadFile('/reports/InstitutionTrialBalance.mrt');
