...
export class FixedAssetsOfInstitutionComponent implements OnInit {
  ...
  private router: Router, private datehelp: DateHelperService, private translate: TranslateService) { }
    ...
    ViewReport() {
      ...
      this.ReportSer.FixedAssetsOfInstitution(this.sDate,this.eDate, this.ComIDS, this.dbIds,this.currentLocation).subscribe(
        (data: Response) => {
          debugger;
          this.result = data;
    ...
    ViewReportDesign() {
      debugger;
      this.reportName= "FixedAssetsOfInstitution";
