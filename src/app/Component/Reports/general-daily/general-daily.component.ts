...
@Component({
  selector: 'app-general-daily',
  templateUrl: './general-daily.component.html',
  styleUrls: ['./general-daily.component.css']
})
export class GeneralDailyComponent implements OnInit {
  ...
  private router: Router, private datehelp: DateHelperService, private translate: TranslateService) { }
    ...
    ViewReport() {
      ...
      this.ReportSer.GeneralDaily(this.sDate,this.eDate, this.ComIDS, this.dbIds).subscribe(
        (data: Response) => {
          debugger;
          this.result = data;
